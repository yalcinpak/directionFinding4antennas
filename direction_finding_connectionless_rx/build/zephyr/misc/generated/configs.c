...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_PERIODIC_ADV_LIST_SIZE, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DF_CONNECTIONLESS_CTE_RX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DF_CTE_RX_AOA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_CTE_TX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_CTE_RX_SAMPLE_1US, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_ANT_SWITCH_1US, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_ANT_SWITCH_RX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_CTE_RX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SCAN_CTE_RX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SAMPLE_CTE_FOR_PDU_WITH_BAD_CRC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_MAX_ANT_SW_PATTERN_LEN, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_INIT_ANT_SEL_GPIOS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_PER_SCAN_CTE_NUM_MAX, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SWITCH_OFFSET, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SAMPLE_OFFSET_PHY_1M_SAMPLING_1US, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SAMPLE_OFFSET_PHY_2M_SAMPLING_1US, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SAMPLE_OFFSET_PHY_1M_SAMPLING_2US, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DF_SAMPLE_OFFSET_PHY_2M_SAMPLING_2US, 20);
